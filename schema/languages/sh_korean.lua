LANGUAGE = {
	...
	["Scrap metal"] = "금속 조각",
	itemMetalDesc = "어딘가에서 떨어져 나온 금속 조각입니다.",
	...
	["Ranger casual outfit"] = "NCR 레인저 의상",
	itemNCRRangerCasualDesc = "NCR 군대의 정예병인 레인저들이 입는 복장입니다.",
	...
	item44Revolver = "스윙 아웃 실린더를 채택한 더블 액션 .44 매그넘 리볼버 권총입니다.\n.44 매그넘 권총 탄약을 사용합니다.",
	...
	itemCravanShotgunDesc = "황무지를 오가는 캐러밴들이 주로 사용하는 더블 배럴 산탄총입니다.\n20 게이지 산탄을 사용합니다.",
	["Cattle prod"] = "소몰이 막대",
	...
	itemChineseAssaultRilfeDesc = "대전쟁 이전 중공군의 제식 소총으로 탄약 수급을 원활하게 하기 위해 5.56mm 소총탄을 사용합니다.",
	...
	["AE9 laser rifle"] = "AE9 레이저 소총", -- Fallout 3
	["Laser rifle"] = "레이저 소총",
